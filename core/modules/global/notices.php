	...
	new ITSEC_Admin_Notice_Remind_Me(
		new ITSEC_Admin_Notice_Managers_Only(
			new class implements ITSEC_Admin_Notice {
				...
				public function get_message() {
					return __( 'Automatic IP detection is susceptible to IP spoofing attacks.', 'it-l10n-ithemes-security-pro' ) . ' ' .
					       __( 'We recommend enabling Security Check to securely configure IP detection.', 'it-l10n-ithemes-security-pro' ) . ' ' .
					       __( 'Alternatively, manually configure <a href="{{ $configure }}">Proxy Detection</a> based on your server setup.', 'it-l10n-ithemes-security-pro' );
				}
