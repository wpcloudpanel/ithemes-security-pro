...
class ITSEC_Two_Factor {
	...
	public function user_two_factor_options( $user ) {
		...
		<p><?php esc_html_e( 'Enabling two-factor authentication greatly increases the security of your user account on this site. With two-factor authentication enabled, after you submit your username and password, you will be asked for an additional authentication code to complete your login.', 'it-l10n-ithemes-security-pro' ); ?>
			<strong> <?php esc_html_e( 'Two-factor authentication codes can come from an app that runs on your mobile device, an email that is sent to you after you log in with your username and password, or from a pre-generated list of codes.', 'it-l10n-ithemes-security-pro' ); ?></strong> <?php esc_html_e( 'The settings below allow you to configure which of these authentication code providers are enabled for your user.', 'it-l10n-ithemes-security-pro' ); ?>
		</p>
	...
	public function send_setup_reminder( WP_User $recipient, WP_User $requester = null ) {
		...
		$mail->add_list( array(
			...
			esc_html__( 'With two-factor authentication enabled, after you submit your username and password, you will be asked for an additional authentication code to complete your login.', 'it-l10n-ithemes-security-pro' ),
			sprintf(
