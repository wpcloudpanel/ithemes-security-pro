...
class ITSEC_File_Change_Scanner {
	...
	private function generate_notification_email( $email_details ) {
		...
		$mail->add_header(
			...
			false,
			esc_html__( 'Files on your site have changed since the last scan. Please review the report below to verify the changes are expected.', 'it-l10n-ithemes-security-pro' ),
		);
