...
final class ITSEC_Import_Export_Exporter {
	public static function create( $email ) {
		...
		$tracking_link = ITSEC_Core::is_pro()
			? 'https://go.solidwp.com/security-settings-export-email-ithemes-becoming-solidwp'
			: 'https://go.solidwp.com/security-free-settings-export-email-ithemes-becoming-solidwp';
