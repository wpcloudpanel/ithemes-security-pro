...
/**
 * Manage and configure all the notifications sent by Solid Security. View any errors that arise during the sending of notifications.
 */
class ITSEC_Notification_Center_Command extends WP_CLI_Command {
	...
	public function send( $args, $assoc_args ) {
		...
		if ( empty( $assoc_args['force'] ) ) {
			...
			WP_CLI::debug('calling the force side of the function');
