...
class ITSEC_Two_Factor_User_Method_Command {
	...
	/**
	 * Gets the Two-Factor config for a method.
	 *
	 * ## OPTIONS
	 *
	 * <user_id>
	 * : The user id to get the config for.
	 *
	 * <method>
	 * : The method.
	 *
	...
	public function get_config( $args, $assoc_args ) {
		...
		if ( $provider instanceof ITSEC_Two_Factor_Provider_CLI_Configurable ) {
			$provider->get_config_for_cli( $user, $assoc_args );
		}
	}
...
class ITSEC_Two_Factor_User_Remind_Command {
	...
	public function __invoke( $args, $assoc_args ) {
		...
		$sent = ITSEC_Two_Factor::get_instance()->send_setup_reminder( $user, $requester );
