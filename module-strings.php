...
__( 'Determine how Solid Security identifies your visitor’s IP addresses. Choose the Security Check Scan to allow Solid Security to accurately identify malicious IPs attacking your website.', 'it-l10n-ithemes-security-pro' );
__( 'Proxy Header', 'it-l10n-ithemes-security-pro' );
__( 'Select the header your proxy server uses to forward the client IP address. If you don’t know the header, you can contact your hosting provider or select the header that shows your true IP address.', 'it-l10n-ithemes-security-pro' );
__( 'Allow Data Tracking', 'it-l10n-ithemes-security-pro' );
__( 'Allow Solid Security to track plugin usage with anonymized data.', 'it-l10n-ithemes-security-pro' );
